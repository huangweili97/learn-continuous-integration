...
const Question = ({ q, clickTag, handleAnswer }: QuestionProps) => {
  return (
    <div
      ...
      // Code Smells: Non-interactive DOM elements should not have an interactive handler(add role="button")
      role="button"
    >
      ...
      <div className="question_mid">
        ...
        <div className="question_tags">
          {q.tags.map((tag, idx) => {
            return (
              <button
                // Code Smells: Do not use Array index in keys(key={idx} => key={tag._id})
                key={tag._id}
