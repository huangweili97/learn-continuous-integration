 ...
 * @description Increments the upvote count of a question
 * @returns {Promise<IQuestionDocument>} The updated question document
 */
QuestionSchema.methods.incrementUpvote =
  async function (): Promise<IQuestionDocument> {
    this.upvoteCount += 1;
    return this.save();
  };
 ...
 * @description Decrements the upvote count of a question
 * @returns {Promise<IQuestionDocument>} The updated question document
 */
QuestionSchema.methods.decrementUpvote =
  async function (): Promise<IQuestionDocument> {
 ...
 * @description Increments the downvote count of a question
 * @returns {Promise<IQuestionDocument>} The updated question document
 */
QuestionSchema.methods.incrementDownvote =
  async function (): Promise<IQuestionDocument> {
 ...
 * @description Decrements the downvote count of a question
 * @returns {Promise<IQuestionDocument>} The updated question document
 */
QuestionSchema.methods.decrementDownvote =
  async function (): Promise<IQuestionDocument> {
